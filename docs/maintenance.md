...
- Update verified credential cards in `src/data/certifications.ts`.
...
- Keep credential badge images in `public/certifications/` and link them to a public verification URL.
