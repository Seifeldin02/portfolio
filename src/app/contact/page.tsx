        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-10 lg:gap-16">
          <RevealOnView className="space-y-4">
            ...
            <p className="text-sm text-muted pt-2">
              ...
              <a
                href={`mailto:${siteConfig.email}`}
                className="inline-flex min-h-10 items-center rounded-md text-accent hover:text-accent-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
              >
                {siteConfig.email}
              </a>
            </p>
