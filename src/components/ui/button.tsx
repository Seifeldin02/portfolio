...
export function buttonClassName({
  ...
  return cn(
    'font-medium rounded-lg transition-all inline-flex items-center justify-center whitespace-nowrap',
    ...
    'disabled:opacity-50 disabled:pointer-events-none',
    {
      ...
      'bg-accent text-white hover:bg-accent-hover hover:-translate-y-0.5': variant === 'primary',
